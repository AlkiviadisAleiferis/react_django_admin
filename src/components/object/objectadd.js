...
export function ObjectAdd({ app, model, fieldsets, readonly_fields, fields, inlines, extra_data }) {
    /* 
        DATA STRUCTURE
    ...
    */
    ...
    const BelowActions = extra_sections.object.add.below_actions[section_code];
    const BelowForm = extra_sections.object.add.below_form[section_code];
