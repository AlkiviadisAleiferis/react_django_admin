...
export function PasswordChange({ props }) {
    ...
    return (
        <Container fluid className="p-1 fade-in">
            <RouterForm method="post" id="change_password" encType="multipart/form-data">
                <Row className="p-0 mx-0 w-100 justify-content-center">
                    <div className="col-12  d-flex flex-column">{non_form_errors_jsx}</div>

                    <div className="col-12 col-md-8 d-flex flex-column">
                        <label className="control-label float-md-right">Old password</label>
                        <input
                            type="password"
                            name="old_password"
                            required=""
                    ...
                    <div className="col-12 col-md-8 mt-5 d-flex flex-column">
                        <label className="control-label float-md-right">New password</label>
                        <input
                            type="password"
                            name="password1"
                            required=""
                    ...
                    <div className="col-12 col-md-8 d-flex flex-row mt-3">
