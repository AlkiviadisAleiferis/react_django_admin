        ...
        if (perms_needed && perms_needed.length) {
            inner_deletion_jsx = (
                <>
                    <p>
                        <b>
                            Deleting the selected objects would result in deleting related objects,
                            but your account doesn't have permission to delete the following types
                            of objects:
                        </b>
                    </p>
            ...
            inner_deletion_jsx = (
                <>
                    <p>
                        <b>
                            Deleting the selected objects would require deleting the following
                ...
                <>
                    <Row className="p-4">
                        <Col xs="12" className="d-flex flex-column">
                            <p>
                                <b>
                                    Are you sure you want to delete selected objects? All of the
                                    following related items will be deleted:
                                </b>
                            </p>
                            <NestedObjectsList nested_objects={deletable_objects} />
                        </Col>
                    </Row>
                    ...
                    <Row className="justify-content-end my-4 p-4">
                        <Col xs="12" sm="6" lg="4" xxl="4" className="d-flex flex-column">
                            <input
                                type="submit"
